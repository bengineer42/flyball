from humctrl.core.errors import ConflictError, HumCtrlError, NotFoundError


class StoreError(HumCtrlError):
    """Base for everything humctrl.db raises."""
...
class NotDeclaredError(StoreError, ConflictError):
    """A row named a source, quantity or loop the session never declared."""
