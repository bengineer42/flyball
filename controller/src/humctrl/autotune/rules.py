...
:meth:`~humctrl.autotune.types.Gains.of_ideal`, so the coefficients here can be
...
:class:`~humctrl.autotune.types.FOPDT` from a step test; :func:`ziegler_nichols`
and :func:`tyreus_luyben` take an :class:`~humctrl.autotune.types.Ultimate` from
