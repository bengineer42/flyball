...
class FOPDT:
    ...
    (``dead_time``). Every rule in :mod:`humctrl.autotune.rules` that takes a
    ...
    :func:`~humctrl.controller.calculate_wet_fraction` has already divided out
    the ``wet - dry`` span.
    """
...
class Gains:
    ...
    kd: float = 0.0
    tt: float = 0.0
    """Back-calculation tracking constant, for :class:`~humctrl.controller.laws.IComponent`."""
