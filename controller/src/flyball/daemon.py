...
directly, and :mod:`flyball.cli` drives it over the same HTTP API the browser
uses.
"""
...
from examples.humdiity.pumps import DualPumps, PumpPair
from examples.humdiity.readers import HTReading
...
def build_rig(args: argparse.Namespace) -> HumRig:
    ...
    """
    from examples.humdiity.direct import I2CSHT4x, LinuxPWMPump
...
def parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="flyball-daemon", description=__doc__)
