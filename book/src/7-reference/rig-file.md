...
`null` clears it to the unset default (`label` the driver's, else the name humanised, a band
...
| key | type | |
| --- | --- | --- |
| `label` | string, optional | what a person reads for the controller; left out: its output signal's label |
