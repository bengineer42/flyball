...
`http://host:8000` by default; `--host 0.0.0.0` to be reachable (with a
password or a token: [an open runner stays on loopback](../1-running/runner/access.md#the-door-a-password-a-token-or-open)); a
