...
| section | |
| --- | --- |
| [Starting a rig](daemon/index.md) | `flyball-daemon rig.yaml`; what it serves; [access](daemon/access.md) (the door, a sub-path, stopping); [building a rig while it runs](daemon/building.md) |
