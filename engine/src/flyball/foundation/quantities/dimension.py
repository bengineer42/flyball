...
A [BaseDimension][flyball.foundation.quantities.dimension.BaseDimension] is irreducible:
the seven of the SI, plus angle and solid angle. A
[Dimension][flyball.foundation.quantities.dimension.Dimension] is a product of their
powers; two units convert only if theirs agree. A
[Unit][flyball.foundation.quantities.dimension.Unit] is a magnitude on a dimension: a
...
class NamedDimension(Dimension):
    ...
    Arithmetic yields a plain [Dimension][flyball.foundation.quantities.dimension.Dimension].
    """
...
class Unit:
    ...
    def quantity(self, name: str | None = None) -> Quantity:
        """A [Quantity][flyball.foundation.quantities.quantity.Quantity] in this unit.
